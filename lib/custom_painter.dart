...
class ShapePainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.quadraticBezierTo(size.width * 0.055, size.height * 0.975, size.width * 0.1, size.height * 0.75); // B - C
    ...
    path.quadraticBezierTo(size.width * (1 - 0.055), size.height * 0.975, size.width, size.height);
